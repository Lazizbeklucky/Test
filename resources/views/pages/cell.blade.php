...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/cabinet-{{$datas->parent_id}}">Cabinet</a></li>
...
@foreach($datas->getFolderFromCabinet as $item)
  
    <div class="col-md-3">
<div class="card bg-light mb-3" style="max-width: 18rem;">
<a href="/cabinet-{{$datas->parent_id}}/cell-{{$datas->id}}/folder-{{$item->id}}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
 <form  action="/folder_create" method="post" >
  <input type="hidden" name="id" value="{{$datas->id}}">
  <input type="hidden" name="url" value="{{Request::path()}}">
